...
var TRANSLATIONS = {
  nl: {
    ...
    "clientSubtitle": "Voer hier de gegevens van de klant in. Deze worden bewaard op dit apparaat en getoond op de export-rapporten.",
    ...
    "techAppLabel": "Toepassingsomschrijving",
    "techBrandLabel": "Merk",
    "techProductLabel": "Huidig smeermiddel / product",
    ...
    "pdfOptInclTcoDesc": "Genereert een pagina inclusief het vergelijkende kostenmodel (Manuele smeerkost vs. Interflon).",
    "pdfOptExclTco": "Exclusief TCO Calculatie model",
    "pdfOptExclTcoDesc": "Slaat de TCO kostenpagina over in het rapport.",
    ...
    "searchEmptyDesc": "Zoek en selecteer een lager hierboven om technische specificaties en maatschets te tonen.",
    "selectedBearingTitle": "Technische Specificaties",
    "estimatedNote": "Let op: Dit lager is niet gevonden in de vaste database. De afmetingen hieronder zijn berekend en geschat op basis van de SKF aanduiding. Gelieve te verifiëren.",
    "bearingType": "Type lager",
    "boreDiameter": "Boring (d)",
    "outerDiameter": "Buitendiameter (D)",
    "widthB": "Breedte (B)",
    "dynLoad": "Dynamische draaglast (C)",
    "statLoad": "Statische draaglast (C0)",
    "refSpeed": "Referentietoerental",
    "limitingSpeed": "Grenstoerental",
    "weightG": "Massa (G)",
    "btnToCalculations": "Ga naar Smeercalculatie",
    "bearingIllustrationTitle": "Lagertype Illustratie",
    "visualDimensionsTitle": "Visuele Afmetingen",
    "boreDiameterShort": "Boring (d)",
    "outerDiameterShort": "Buitendiameter (D)",
    "widthBShort": "Breedte (B)",
    "calcBannerSubtitleEmpty": "Keer terug naar 'Lager Opzoeken' om een lager te laden, of vul handmatig afmetingen in.",
    "cardInputs": "Bedrijfsparameters & Invoer",
    "omInstructionText": "Vul de grijze cellen in",
    "btnCheckCompatibility": "Controleer verdikker compatibiliteit",
    ...
    "inputMicPolFactorLabel": "Conversiefactor MicPol® (fm)",
    "descMicPolFactor": "Smeerinterval verlengingsfactor door Interflon MicPol® technologie.",
    ...
    "inputSpeedLabel": "Bedrijfssnelheid / Toerental (r/min)",
    "descSpeed": "Draaisnelheid van het lager.",
    "inputLimitSpeedLabel": "Limiting Speed / Grenstoerental (r/min)",
    ...
    "resDnFactor": "Lager DN-factor",
    "resGreaseLimitLabel": "Vet DN-limiet",
    "warningDnLimit": "Gevaar: De lager DN-factor overschrijdt de limiet van het geselecteerde vet!",
    ...
    "omTotalSavingsLabel": "Kostenbesparing na 10",
    ...
    "omCostPerMachineYears": "Kostprijs / machine na 10 jaar (€)",
    "omSavingsMachineYears": "Kostenbesparing / machine / na 10 jaar (€)",
    "omCostParkYears": "Kostprijs / machinepark na 10 jaar (€)",
    "omSavingsParkYears": "Kostenbesparing / machinepark / na 10 jaar (€)",
    ...
    "labelDispensePeriod": "Automatische Looptijd / Leeglooptijd",
    "unitMonths": "maanden",
    "unitWeeks": "weken",
    "unitDays": "dagen",
    ...
    "infoIntro": "Welkom bij de Interflon Lager Smeercalculator. Dit systeem is speciaal ontworpen om onderhoudsengineers en operatoren te helpen bij het bepalen van de optimale smeerparameters voor roterende machines.",
  ...
  en: {
    "loginTitle": "Interflon Grease Calculator",
    "loginSubtitle": "Enter the password to gain access to the application.",
    ...
    "btnLogout": "Log Out",
    "pageSearchTitle": "Bearing Lookup",
    ...
    "searchEmptyDesc": "Search and select a bearing above to display technical specifications and dimensional drawing.",
    "selectedBearingTitle": "Technical Specifications",
    "estimatedNote": "Let op: Dit lager is niet gevonden in de vaste database. De afmetingen hieronder zijn berekend en geschat op basis van de SKF aanduiding. Gelieve te verifiëren.",
    "bearingType": "Bearing type",
    "boreDiameter": "Bore diameter (d)",
    ...
    "weightG": "Weight (G)",
    "btnToCalculations": "Go to Grease Calculation",
    "bearingIllustrationTitle": "Bearing Type Illustration",
    "visualDimensionsTitle": "Visual Dimensions",
    "boreDiameterShort": "Bore (d)",
    "outerDiameterShort": "Outer Diameter (D)",
    "widthBShort": "Width (B)",
    "calcBannerSubtitleEmpty": "Keer terug naar 'Lager Opzoeken' om een lager te laden, of vul handmatig afmetingen in.",
    "cardInputs": "Operating Parameters & Inputs",
    "omInstructionText": "Vul de grijze cellen in",
    "btnCheckCompatibility": "Check thickener compatibility",
    "inputGreaseLabel": "Select Interflon Grease",
    "descGrease": "Determines maximum DN factor and consistency",
    "btnProductInfo": "Ga naar productinfo",
    "thickenerSelectLabel": "Select current grease thickener",
    "inputMicPolFactorLabel": "MicPol® conversion factor (fm)",
    "descMicPolFactor": "Relubrication interval extension factor due to Interflon MicPol® technology.",
    ...
    "descDaysPerWeek": "Number of days the machine operates per week.",
    "inputTempLabel": "Operating temperature (°C)",
    "descTemp": "Determines temperature correction factor Tt.",
    "inputSpeedLabel": "Operating speed (r/min)",
    "descSpeed": "Rotational speed of the bearing.",
    "inputLimitSpeedLabel": "Limiting speed (r/min)",
    "descLimitSpeed": "Limiting speed rating of the bearing.",
    ...
    "teOptionDust": "Dust/moisture / High (0.5)",
    "teOptionMoisture": "Dust/moisture / Very high (0.3)",
    ...
    "taOptionVert": "Vertical axis / Extreme (0.15)",
    "speedGreaseLimitsTitle": "Speed & Grease Limits",
    "resDnFactor": "Bearing DN factor",
    "resGreaseLimitLabel": "Grease DN limit",
    "warningDnLimit": "Warning: Bearing DN factor exceeds selected grease limit!",
    "freeVolInitFillTitle": "Free Volume & Initial Fill",
    "resFreeVolLabel": "Free volume (V)",
    "resFillPercentLabel": "Fill percentage",
    "resInitialFillLabel": "Initial fill quantity",
    "unitGrams": "grams",
    "frequencyIntervalTitle": "Lubrication Frequency / Interval",
    "resBaseIntervalLabel": "Base frequency under optimal lab conditions (FB)",
    "unitBedrijfsuren": "operating hours",
    "lblDays": "Days",
    "lblWeeks": "Weeks",
    "lblMonths": "Months",
    "resTempFactorLabel": "Temperature factor (Tt)",
    "resIntervalLabel": "Corrected interval with conventional lubricant (FC)",
    "resIntervalMicPolLabel": "Relubrication interval with Interflon MicPol® technology",
    "refillVolumeTitle": "Relubrication Volume (Refills)",
    "resCoefCLabel": "Coefficient C",
    "unitGramsVet": "grams grease",
    ...
    "densityInfoTextPost": "Fill quantity = cm³ x density.",
    ...
    "automationSubtitle": "Calculation when using automatic lubricators",
    ...
    "autoNumDevicesHint": "Divide the bearings across 1 or more devices (e.g. 1 device with 4 bearings and 1 device with 2 bearings).",
    "automationParamsTitle": "Device Parameters & Lubrication Setting",
    "btnApplyRec": "Apply recommendation",
    "autoCalcHeaderTitle": "Lubrication Interval & Dosing for 1 bearing",
    "labelNumBearings": "Number of bearings to lubricate",
    "labelCartridgeCap": "Cartridge Capacity (ml)",
    "labelDispensePeriod": "Desired Operating Time / Dispense Period",
    "unitMonths": "months",
    "unitWeeks": "weeks",
    "unitDays": "days",
    "autoDialSetting": "Dial setting on device:",
    "autoTheoCalculated": "• Theoretically calculated:",
    "roiSyncLabel": "Synchronized with Automation",
    "roiCalculatedGreaseCons": "Calculated Grease Consumption",
    "roiLifetimeInfoText": "Switching from manual to automatic lubrication typically extends bearing service life by 50% to 300% (factor 1.5 to 4) in practice. In heavy, contaminated, or continuous operations, service life can increase by a factor of 4 to 8.",
    "roiLifetimeExtensionLabel": "Lifetime Extension:",
    ...
    "roiLabelYearlyCons": "Annual grease consumption:",
    "roiLabelPricePerLiter": "Grease price per liter:",
    "roiLabelYearlyGreaseCost": "Annual grease cost:",
    "roiLabelTotalBeurten": "Total bearing lubrication services/year:",
    "roiLabelTimePerBeurt": "Time per service (minutes):",
    "roiLabelHourlyRate": "Technician hourly rate:",
    "roiLabelYearlyLaborCost": "Annual labor cost:",
    "roiLabelRepairTime": "Overhaul labor cost (annual):",
    "roiLabelPartsCost": "Spare parts cost (annual):",
    "roiLabelDowntimeCost": "Downtime cost (annual):",
    "roiTotalManualTitle": "Total Annual Manual Cost",
    "roiAutoCardTitle": "Automatic Lubrication",
    "roiAutoCardSubtext": "With selected lubricator unit (annual basis)",
    "roiLabelChosenDevice": "Selected lubricator unit:",
    "roiLabelCartridgesCons": "Cartridges consumption/year:",
    "roiLabelEmptyDevicePrice": "Empty device price:",
    "roiLabelPricePerPack": "Price per cartridge / service pack:",
    "roiLabelYearlyPacksCost": "Annual cartridge cost:",
    "roiLabelInstallKit": "Pulsarlube installation kit:",
    "roiLabelDividerBlocks": "Divider block(s):",
    "roiLabelCartridgeChangeLabor": "Cartridge change labor cost:",
    "roiYear1Total": "Year 1 Total",
    "roiYear2PlusRecurring": "Year 2+ Recurring",
    "roiFinancialAnalysisTitle": "Financial Analysis & ROI Result",
    "roiFinancialAnalysisSubtitle": "Direct comparison of manual labor & grease vs. automatic lubrication unit",
    "roiNetYearlySavingTitle": "Structural Annual Savings",
    "roiFromYear2": "From Year 2",
    "roiYear1NetTitle": "Year 1 Net Result",
    ...
    "roiYearsWord": "years",
    "roiImportantNoteHeader": "Important notice:",
    "roiImportantNoteText": "The calculation above reflects exclusively the direct transition from manual to automatic lubrication. In practice, the largest financial and operational benefit comes from increased operational reliability (higher output), longer component service life (fewer spare parts), and a significant reduction in overhaul hours.",
    "infoTitle": "Over deze Webapplicatie",
    "infoIntro": "Welkom bij de Interflon Lager Smeercalculator. Dit systeem is speciaal ontworpen om onderhoudsengineers en operatoren te helpen bij het bepalen van de optimale smeerparameters voor roterende machines.",
    "legalDisclaimerText": "De gegenereerde gegevens bieden een betrouwbare indicatie, maar vormen geen expliciete garantie dat een product of dosering geschikt is voor elke specifieke toepassing. De calculator biedt een adviesrichtlijn; er kan geen wettelijke waarborg of aansprakelijkheid worden verleend met betrekking tot het concrete gebruik ervan in de praktijk.",
    "infoMicPolTitle": "MicPol® technologie",
  ...
  fr: {
    "loginTitle": "Calculateur de Graisse Interflon",
    "loginSubtitle": "Saisissez le mot de passe pour accéder à l'application.",
    "selectLanguageLabel": "Sélectionnez votre langue",
    ...
    "selectChainCalcDesc": "Bereken olie-doseringen, volume per minuut, smeerintervallen en instellingen voor automatisatie voor aandrijf- en transportkettingen.",
    "selectChainCalcBtn": "Open Kettingberekening",
    "menuSearch": "Rechercher un Roulement",
    "menuCalc": "Calcul de Graissage",
    "menuOm": "Modèle de Rendement",
    ...
    "pageSearchTitle": "Rechercher un Roulement",
    "pageSearchSubtitle": "Entrez un numéro de roulement SKF pour afficher toutes les spécifications techniques.",
    "operatorBadge": "Interflon contactpersoon",
    "clientBadge": "Klant",
    "techBadge": "Technical data",
    "photoLibraryBadge": "Foto bibliotheek",
    "btnLagertypes": "Types de Roulements",
    "searchEmptyTitle": "Aucun roulement sélectionné",
    "searchEmptyDesc": "Recherchez et sélectionnez un roulement ci-dessus pour afficher les spécifications techniques et le dessin dimensionnel.",
    "selectedBearingTitle": "Spécifications Techniques",
    "estimatedNote": "Let op: Dit lager is niet gevonden in de vaste database. De afmetingen hieronder zijn berekend en geschat op basis van de SKF aanduiding. Gelieve te verifiëren.",
    "bearingType": "Type de roulement",
    "boreDiameter": "Alésage (d)",
    "outerDiameter": "Diamètre extérieur (D)",
    "widthB": "Largeur (B)",
    "dynLoad": "Charge dynamique (C)",
    "statLoad": "Charge statique (C0)",
    "refSpeed": "Vitesse de référence",
    "limitingSpeed": "Vitesse limite",
    "weightG": "Masse (G)",
    "btnToCalculations": "Aller au Calcul de Graissage",
    "bearingIllustrationTitle": "Illustration Type de Roulement",
    "visualDimensionsTitle": "Dimensions Visuelles",
    "boreDiameterShort": "Alésage (d)",
    "outerDiameterShort": "Diamètre Extérieur (D)",
    "widthBShort": "Largeur (B)",
    "calcBannerSubtitleEmpty": "Keer terug naar 'Lager Opzoeken' om een lager te laden, of vul handmatig afmetingen in.",
    "cardInputs": "Paramètres de Fonctionnement & Saisies",
    "omInstructionText": "Vul de grijze cellen in",
    "btnCheckCompatibility": "Vérifier la compatibilité de l'épaississant",
    "inputGreaseLabel": "Sélectionner la Graisse Interflon",
    "descGrease": "Détermine le facteur DN maximal et la consistance",
    "btnProductInfo": "Ga naar productinfo",
    "thickenerSelectLabel": "Sélectionner l'épaississant actuel",
    "inputMicPolFactorLabel": "Facteur de conversion MicPol® (fm)",
    "descMicPolFactor": "Facteur d'extension de l'intervalle de graissage grâce à la technologie Interflon MicPol®.",
    "inputHoursPerDayLabel": "Heures d'exploitation/jour",
    "descHoursPerDay": "Nombre d'heures d'exploitation de la machine par jour.",
    "inputDaysPerWeekLabel": "Jours d'exploitation/semaine",
    "descDaysPerWeek": "Nombre de jours d'exploitation de la machine par semaine.",
    "inputTempLabel": "Température de fonctionnement (°C)",
    "descTemp": "Détermine le facteur de correction de température Tt.",
    "inputSpeedLabel": "Vitesse de fonctionnement (tr/min)",
    "descSpeed": "Vitesse de rotation du roulement.",
    "inputLimitSpeedLabel": "Vitesse limite (tr/min)",
    ...
    "teOptionDust": "Poussière/humidité / Élevé (0,5)",
    "teOptionMoisture": "Poussière/humidité / Très élevé (0,3)",
    ...
    "taOptionVert": "Axe vertical / Extrême (0,15)",
    "speedGreaseLimitsTitle": "Vitesse & Limites de Graisse",
    "resDnFactor": "Facteur DN du roulement",
    "resGreaseLimitLabel": "Limite DN de graisse",
    "warningDnLimit": "Attention : Le facteur DN dépasse la limite de la graisse !",
    ...
    "resInitialFillLabel": "Quantité de remplissage initial",
    "unitGrams": "grammes",
    "frequencyIntervalTitle": "Fréquence / Intervalle de Graissage",
    "resBaseIntervalLabel": "Fréquence de base sous conditions labo (FB)",
    "unitBedrijfsuren": "heures d'exploitation",
    "lblDays": "Jours",
    "lblWeeks": "Semaines",
    "lblMonths": "Mois",
    "resTempFactorLabel": "Facteur de température (Tt)",
    "resIntervalLabel": "Intervalle corrigé avec lubrifiant conventionnel (FC)",
    "resIntervalMicPolLabel": "Intervalle de graissage avec technologie Interflon MicPol®",
    "refillVolumeTitle": "Volume de Appoint (Recharges)",
    "resCoefCLabel": "Coefficient C",
    "unitGramsVet": "grammes de graisse",
    "resRefillDesc": "Quantité de réapprovisionnement (D x B x C)",
    "unitStrokes": "coups",
    "resStrokesDesc": "Pompe à graisse (2g/coup)",
    "densityInfoTitle": "Info Densité :",
    "densityInfoTextPre": "La graisse sélectionnée a une densité de",
    "densityInfoTextPost": "Quantité de remplissage = cm³ x densité.",
    "bearingStatusTitle": "Statut du Roulement & Graissage",
    "omAnnSavingsLabel": "Kostenbesparing / Jaar (park)",
    "omTotalSavingsLabel": "Kostenbesparing na 10",
    "omProdCostPercentLabel": "% Product / Totale Kost",
    "omClientHeader": "Algemene Projectgegevens",
    ...
    "automationSubtitle": "Calcul lors de l'utilisation de graisseurs automatiques",
    "automationDeviceLabel": "Sélectionner l'appareil :",
    "deviceSinglePoint": "Interflon Single Point Lubricator",
    "devicePulsarlubeM2": "Pulsarlube M2",
    "devicePulsarlube": "Pulsarlube MSP",
    "devicePulsarlubePlc": "Pulsarlube PLC (Commande Centrale)",
    ...
    "autoNumDevicesHint": "Répartissez les roulements sur 1 ou plusieurs appareils (ex. 1 appareil avec 4 roulements et 1 appareil avec 2 roulements).",
    "automationParamsTitle": "Paramètres de l'Appareil & Réglage de Lubrification",
    "btnApplyRec": "Appliquer la recommandation",
    "autoCalcHeaderTitle": "Intervalle & Dosage de lubrification pour 1 roulement",
    "labelNumBearings": "Nombre de roulements à graisser",
    "labelCartridgeCap": "Capacité de la cartouche (ml)",
    "labelDispensePeriod": "Durée de fonctionnement souhaitée",
    "unitMonths": "mois",
    "unitWeeks": "semaines",
    "unitDays": "jours",
    "autoDialSetting": "Réglage du bouton sur l'appareil:",
    "autoTheoCalculated": "• Calcul théorique :",
    "roiSyncLabel": "Synchronisé avec l'Automatisation",
    "roiCalculatedGreaseCons": "Consommation de Graisse Calculée",
    "roiLifetimeInfoText": "Le passage du graissage manuel au graissage automatique prolonge généralement la durée de vie des roulements de 50 % à 300 % (facteur 1,5 à 4). Dans des applications sévères ou très polluées, la durée de vie peut augmenter d'un facteur 4 à 8.",
    "roiLifetimeExtensionLabel": "Extension de la durée de vie :",
    "roiManualCardTitle": "Lubrification Manuelle",
    "roiOptionManualInterflon": "Lubrification manuelle avec produit Interflon",
    "roiOptionManualCurrent": "Lubrification manuelle avec produit actuel",
    "roiLabelYearlyCons": "Consommation annuelle de graisse :",
    "roiLabelPricePerLiter": "Prix de la graisse au litre :",
    "roiLabelYearlyGreaseCost": "Coût annuel de graisse :",
    "roiLabelTotalBeurten": "Nombre total de graissages/an :",
    "roiLabelTimePerBeurt": "Temps par graissage (minutes) :",
    "roiLabelHourlyRate": "Taux horaire technicien :",
    "roiLabelYearlyLaborCost": "Coût annuel de main-d'œuvre :",
    "roiLabelRepairTime": "Main-d'œuvre révision (annuelle) :",
    "roiLabelPartsCost": "Coût des pièces détachées (annuel) :",
    "roiLabelDowntimeCost": "Coût de temps d'arrêt (annuel) :",
    "roiTotalManualTitle": "Coût Annuel Total Manuel",
    "roiAutoCardTitle": "Lubrification Automatique",
    "roiAutoCardSubtext": "Avec le graisseur sélectionné (sur base annuelle)",
    "roiLabelChosenDevice": "Graisseur sélectionné :",
    "roiLabelCartridgesCons": "Consommation de cartouches/an :",
    "roiLabelEmptyDevicePrice": "Prix de l'appareil vide :",
    "roiLabelPricePerPack": "Prix par cartouche / service pack :",
    "roiLabelYearlyPacksCost": "Coût annuel des cartouches :",
    "roiLabelInstallKit": "Kit d'installation Pulsarlube :",
    "roiLabelDividerBlocks": "Bloc(s) répartiteur(s) :",
    "roiLabelCartridgeChangeLabor": "Main-d'œuvre changement de cartouche :",
    "roiYear1Total": "Total Année 1",
    "roiYear2PlusRecurring": "Année 2+ Récurrent",
    "roiFinancialAnalysisTitle": "Analyse Financière & Résultat ROI",
    "roiFinancialAnalysisSubtitle": "Comparaison directe main-d'œuvre manuelle & graisse vs. module de graissage automatique",
    "roiNetYearlySavingTitle": "Économie Annuelle Structurelle",
    ...
    "roiSavingsAfter": "Économie après",
    "roiYearsWord": "ans",
    "roiImportantNoteHeader": "Remarque importante :",
    "roiImportantNoteText": "Le calcul ci-dessus reflète uniquement la transition directe du graissage manuel au graissage automatique. En pratique, le gain le plus important provient d'une fiabilité accrue (production plus élevée), d'une durée de vie prolongée des composants et d'une réduction importante des heures de révision.",
    "infoTitle": "Over deze Webapplicatie",
    "infoIntro": "Welkom bij de Interflon Lager Smeercalculator. Dit systeem is speciaal ontworpen om onderhoudsengineers en operatoren te helpen bij het bepalen van de optimale smeerparameters voor roterende machines.",
    "legalDisclaimerText": "De gegenereerde gegevens bieden een betrouwbare indicatie, maar vormen geen expliciete garantie dat een product of dosering geschikt is voor elke specifieke toepassing. De calculator biedt een adviesrichtlijn; er kan geen wettelijke waarborg of aansprakelijkheid worden verleend met betrekking tot het concrete gebruik ervan in de praktijk.",
    "infoMicPolTitle": "MicPol® technologie",
...
function renderAutoDevicesUI() {
  ...
  for (let i = 0; i < numDevices; i++) {
    ...
    <div class="card" style="background: #ffffff; border: 1px solid #cbd5e1; padding: 20px; border-radius: var(--border-radius-md); box-shadow: 0 2px 8px rgba(0,0,0,0.04); flex: 1;">
      <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid var(--accent-yellow); padding-bottom: 8px; margin-bottom: 16px;">
        ...
        ${numDevices > 1 ? `<span style="background-color: #E30613; color: white; font-weight: 800; font-size: 11px; padding: 4px 12px; border-radius: 12px; text-transform: uppercase; white-space: nowrap; flex-shrink: 0;">${lang === 'fr' ? 'Appareil' : (lang === 'en' ? 'Device' : 'Toestel')} ${devId}</span>` : ''}
      </div>
  ...
  if (manBeurtenEl) {
    if (effectiveManBearings > 1) {
      var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
      const bWord = lang === "fr" ? "lubrifications" : (lang === "en" ? "services" : "beurten");
      const lWord = lang === "fr" ? "roulements" : (lang === "en" ? "bearings" : "lagers");
      manBeurtenEl.textContent = `${(manualBeurtenPerYear * effectiveManBearings).toLocaleString("nl-BE", { minimumFractionDigits: 1, maximumFractionDigits: 1 })} (${manualBeurtenPerYear.toLocaleString("nl-BE", { minimumFractionDigits: 1, maximumFractionDigits: 1 })} ${bWord} x ${effectiveManBearings} ${lWord})`;
    } else {
      var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
      const bWord = lang === "fr" ? "lubrifications" : (lang === "en" ? "services" : "beurten");
      manBeurtenEl.textContent = `${manualBeurtenPerYear.toLocaleString("nl-BE", { minimumFractionDigits: 1, maximumFractionDigits: 1 })} ${bWord}`;
    }
  }
  if (manWorkTimeEl) var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
  const minPerBeurt = lang === "fr" ? "min/lubrification" : (lang === "en" ? "min/service" : "min/beurt");
  const hPerYear = lang === "fr" ? "h/an" : (lang === "en" ? "h/year" : "u/jaar");
  manWorkTimeEl.textContent = `${workTimeMinutes} ${minPerBeurt} (${(manualLaborHours).toFixed(1).replace('.',',')} ${hPerYear})`;
  if (manHourlyRateEl) var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
  const perHour = lang === "fr" ? "/ heure" : (lang === "en" ? "/ hour" : "/ uur");
  manHourlyRateEl.textContent = `€ ${hourlyRate.toLocaleString("nl-BE", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ${perHour}`;
  ...
  if (autoAccCostEl) {
    if (totalInstallKitPrice > 0) {
      ...
      var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
      const oneOffStr = lang === "fr" ? "Unique" : (lang === "en" ? "One-off" : "Eenmalig");
      autoAccCostEl.textContent = `€ ${totalInstallKitPrice.toLocaleString("nl-BE", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} (${kitPrefix} ${oneOffStr})`;
    } else {
  ...
  if (autoDivBlockRow) {
    if (totalDividerBlockPrice > 0) {
      ...
      if (autoDivBlockTotalCostEl) {
        var lang = typeof currentLang !== "undefined" ? currentLang : "nl";
        const oneOffStr = lang === "fr" ? "Unique" : (lang === "en" ? "One-off" : "Eenmalig");
        autoDivBlockTotalCostEl.textContent = `€ ${totalDividerBlockPrice.toLocaleString("nl-BE", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} (${oneOffStr})`;
      }
  ...
  if (paybackPeriodEl) {
    ...
    if (initialInvestment <= 0) {
      paybackPeriodEl.textContent = lang === "fr" ? "Retour d'investissement immédiat (0 mois)" : (lang === "en" ? "Immediate Payback (0 months)" : "Directe Terugverdientijd (0 maanden)");
    } else if (netYearlySaving <= 0) {
      paybackPeriodEl.textContent = lang === "fr" ? "Aucun retour sur investissement possible" : (lang === "en" ? "No payback achievable" : "Geen terugverdientijd mogelijk");
    } else {
      const paybackYears = initialInvestment / netYearlySaving;
      const paybackMonths = paybackYears * 12;
      const monthsStr = lang === "fr" ? "mois" : (lang === "en" ? "months" : "maanden");
      const yearsStr = lang === "fr" ? "ans" : (lang === "en" ? "years" : "jaar");
      paybackPeriodEl.textContent = `${paybackMonths.toFixed(1).replace('.', ',')} ${monthsStr} (${paybackYears.toFixed(2).replace('.', ',')} ${yearsStr})`;
    }
  }
...
function changeLanguage(lang) {
  ...
  // 3. Keep language select in sync
  const langSelect = document.getElementById("langSelect");
  if (langSelect && langSelect.value !== currentLang) {
    langSelect.value = currentLang;
  }

  // 4. Re-render dynamic pages that depend on currentLang
  try {
    if (typeof renderAutoDevicesUI === "function") renderAutoDevicesUI();
  } catch(e) {}
  try {
